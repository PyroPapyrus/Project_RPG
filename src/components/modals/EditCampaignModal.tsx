      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-lg shadow-xl transform transition-all duration-300 ease-in-out scale-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 mt-4">
          ...
          <div className="space-y-1">
            <label htmlFor="edit_campaign_name" className="block text-sm font-medium text-gray-700">
              Nome da Campanha
            </label>
            <FormInput
          ...
          {/* Campo Descrição */}
          <div className="space-y-1">
            <label htmlFor="edit_campaign_description" className="block text-sm font-medium text-gray-700">
              Descrição
            </label>
            <FormInput
              id="edit_campaign_description" // ID único
              name="description"
              type="textarea"
              ...
              required
              rows={3} // Ajuste o número de linhas se necessário
              maxLength={500}
            />
          </div>
          ...
          {/* Campo Sistema */}
          <div className="space-y-1">
            <label htmlFor="edit_campaign_system" className="block text-sm font-medium text-gray-700">
              Sistema (D&D 5e, etc.)
            </label>
            <FormInput
              id="edit_campaign_system" // ID único
              name="system"
              type="text"
          ...
          {/* Campo Limite de Jogadores */}
           <div className="space-y-1">
             <label htmlFor="edit_campaign_max_players" className="block text-sm font-medium text-gray-700">
               Limite de Jogadores
             </label>
          ...
          {/* Campo Status */}
           <div className="space-y-1">
             <label htmlFor="edit_campaign_status" className="block text-sm font-medium text-gray-700">
               Status da Campanha
             </label>
             <select
