...
  return (
    <div className="flex justify-self-start gap-4 bg-white rounded-md shadow-sm">

      {/* Dropdown para Filtrar por Status */}
      <div className="flex bg-orange-200 items-center">
        <div>    
...
      <div className="flex bg-orange-700 items-center">
